...
_lr_productions = [
  ...
  ('block -> block statement','block',2,'p_block','calc.py',103),
  ('block -> statement','block',1,'p_block','calc.py',104),
  ('statement -> expression SEMICOLON','statement',2,'p_statement_expr','calc.py',115),
  ('expression -> expression EQUALITY expression','expression',3,'p_expression','calc.py',120),
  ('expression -> expression INEQUALITY expression','expression',3,'p_expression','calc.py',121),
  ('expression -> expression LESS expression','expression',3,'p_expression','calc.py',122),
  ('expression -> expression MORE expression','expression',3,'p_expression','calc.py',123),
  ('expression -> expression LESS_OR_EQUAL expression','expression',3,'p_expression','calc.py',124),
  ('expression -> expression MORE_OR_EQUAL expression','expression',3,'p_expression','calc.py',125),
  ('expression -> expression AND expression','expression',3,'p_expression','calc.py',126),
  ('expression -> expression OR expression','expression',3,'p_expression','calc.py',127),
  ('expression -> expression PLUS expression','expression',3,'p_expression','calc.py',128),
  ('expression -> expression MINUS expression','expression',3,'p_expression','calc.py',129),
  ('expression -> expression TIMES expression','expression',3,'p_expression','calc.py',130),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','calc.py',131),
  ('statement -> NAME EQUALS expression SEMICOLON','statement',4,'p_statement_assign','calc.py',136),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','calc.py',141),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','calc.py',146),
  ('expression -> NUMBER','expression',1,'p_expression_number','calc.py',151),
  ('expression -> NAME','expression',1,'p_expression_name','calc.py',156),
]
