...
_lr_productions = [
  ...
  ('expression -> expression PLUS expression','expression',3,'p_expression_boolean','calc.py',116),
  ('expression -> expression MINUS expression','expression',3,'p_expression_boolean','calc.py',117),
  ('expression -> expression TIMES expression','expression',3,'p_expression_boolean','calc.py',118),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_boolean','calc.py',119),
  ('statement -> NAME EQUALS expression SEMICOLON','statement',4,'p_statement_assign','calc.py',124),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','calc.py',129),
