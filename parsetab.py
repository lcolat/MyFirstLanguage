...
_lr_productions = [
  ...
  ('expression -> expression EQUALITY expression','expression',3,'p_expression','calc.py',108),
  ('expression -> expression INEQUALITY expression','expression',3,'p_expression','calc.py',109),
  ('expression -> expression LESS expression','expression',3,'p_expression','calc.py',110),
  ('expression -> expression MORE expression','expression',3,'p_expression','calc.py',111),
  ('expression -> expression LESS_OR_EQUAL expression','expression',3,'p_expression','calc.py',112),
  ('expression -> expression MORE_OR_EQUAL expression','expression',3,'p_expression','calc.py',113),
  ('expression -> expression AND expression','expression',3,'p_expression','calc.py',114),
  ('expression -> expression OR expression','expression',3,'p_expression','calc.py',115),
  ('expression -> expression PLUS expression','expression',3,'p_expression','calc.py',116),
  ('expression -> expression MINUS expression','expression',3,'p_expression','calc.py',117),
  ('expression -> expression TIMES expression','expression',3,'p_expression','calc.py',118),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','calc.py',119),
